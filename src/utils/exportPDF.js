...
export function exportPDF(user, exportSessions, wastageHistory) {
  ...
  doc.text("StudyTimer Pro — Study Report", 14, 12);
  ...
  doc.text("StudyTimer Pro — Charts & Progress", 14, 12);
  ...
  doc.text(`Generated by StudyTimer Pro · ${new Date().toLocaleString()}`, 14, 286);

  doc.save(`StudyTimer-Report-${today}.pdf`);
}
