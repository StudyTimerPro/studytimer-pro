...
export default function GroupNotifications({ groupId, joinRequests, pendingPlans, pendingLibrary, onClose, showToast, members }) {
    ...
    <div onClick={e => e.target === e.currentTarget && onClose()}
      ...
      <div style={{ background: "var(--surface)", borderRadius: 14, padding: 20, width: "min(360px,95vw)", maxHeight: "88vh", overflowY: "auto", boxShadow: "0 20px 60px rgba(0,0,0,.25)" }}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 16 }}>
          <h3 style={{ fontSize: 15, fontWeight: 700, color: "var(--ink)", margin: 0 }}>🔔 Group Requests ({total})</h3>
